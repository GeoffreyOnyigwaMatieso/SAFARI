...
if(isset($_POST["submit"])){
    ...
    $mail->Body = "Hello, $fname,$lname Your Account Has been created Successfully ";
...
<!-- Mails ends here  -->
  ...
  <div class="registration_form">
    <div class="title">
      Sign Up for Usafiri Bus Service
    </div>
    ...
    <form action="#" method="POST">
      <div class="form_wrap">
        ...
        <div class="input_wrap">
          <input type="submit" value="Register Now" name="submit" class="submit_btn">
        </div>
